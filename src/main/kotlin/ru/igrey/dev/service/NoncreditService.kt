...
class NoncreditService {
    ...
    fun getIEDocuments(casId: String, month: String, type: String): File? {
        return try {
    ...
    fun getCompanyDocuments(companyId: String, month: String, type: String): File? {
        return try {
            val httpClient = HttpClients.createDefault()
    ...
    private fun getRequestIE(casId: String, month: String, type: String): HttpGet {
    ...
    private fun getRequestCompany(companyId: String, month: String, type: String): HttpGet {
